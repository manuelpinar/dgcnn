...
parser.add_argument('--path_data', default='C:/Users/manue/Desktop/Universidad/DOCTORADO/TEORIA/Point_Cloud/dgcnn-master/tensorflow/data/data_h5', help='folder with train test data')
